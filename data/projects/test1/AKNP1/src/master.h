...
int master = 1;
int nomer = 1;
#define aknp1_VCHSK1	 BUFFER[0]	//(VCHSK1)
#define idaknp1_VCHSK1	 1	//(VCHSK1)
#define aknp1_VCHSK2	 BUFFER[5]	//(VCHSK2)
#define idaknp1_VCHSK2	 2	//(VCHSK2)
#define aknp1_VCHSK3	 BUFFER[10]	//(VCHSK3)
#define idaknp1_VCHSK3	 3	//(VCHSK3)
#define aknp1_VCHSK4	 BUFFER[15]	//(VCHSK4)
#define idaknp1_VCHSK4	 4	//(VCHSK4)
...
static VarCtrl allVariables[]={      // Описание всех переменных
	{ 1	,8	,1	, &aknp1_VCHSK1},	//(VCHSK1)
	{ 2	,8	,1	, &aknp1_VCHSK2},	//(VCHSK2)
	{ 3	,8	,1	, &aknp1_VCHSK3},	//(VCHSK3)
	{ 4	,8	,1	, &aknp1_VCHSK4},	//(VCHSK4)
	{ 5	,1	,1	, &POWER1},	//(POWER1 )
	{ 6	,1	,1	, &POWER2},	//(POWER2 )
	{ 7	,1	,1	, &DOOR},	//(DOOR   )
	{ 8	,1	,1	, &T43},	//(T43    )
...
static ModbusRegister ir_AKNP1[]={  // 
	{&aknp1_VCHSK1,8,0},	//(aknp1_VCHSK1) aknp1_VCHSK1
	{&aknp1_VCHSK2,8,2},	//(aknp1_VCHSK2) aknp1_VCHSK2
	{&aknp1_VCHSK3,8,4},	//(aknp1_VCHSK3) aknp1_VCHSK3
	{&aknp1_VCHSK4,8,6},	//(aknp1_VCHSK4) aknp1_VCHSK4
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
...
static ModbusDevice modbuses[]={
	{0,502,&coil_AKNP1[0],&di_AKNP1[0],&ir_AKNP1[0],&hr_AKNP1[0],NULL,NULL,NULL,0},	 //Пустые сигналы AKNP1
